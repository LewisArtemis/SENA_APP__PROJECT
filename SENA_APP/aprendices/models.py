...
class InstructorCurso(models.Model):
    ...
    fecha_asignacion = models.DateField(auto_now_add=True, verbose_name= "Feha de Asignacion")
...
class AprendizCurso(models.Model):
    ...
    curso = models.ForeignKey(Curso, on_delete= models.CASCADE)
    fecha_iscripcion = models.DateField(auto_now_add= True, verbose_name= "Fecha de Inscripción")
    estado = models.CharField(max_length=3, choices= ESTADO_CHOICES, default='INS', verbose_name= "Estado en el Curo")
    ...
    class Meta:
        ...
        verbose_name_plural = "Aprendiz por Curso"
