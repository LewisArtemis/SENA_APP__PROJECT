...
class AprendizForm(forms.Form):
    ...
    def clean_telefono(self):
        ...
        if telefono and not telefono.isdigit():
            raise forms.ValidationError("El telefono debe contener solo números. ")
        return telefono
    
    #crear un metodo para guardar los datos del formulario en la base de datos
    def save(self):
